...
$(document).ready(function () {   
        ...
        for (var i = 0; i < tr_count; i++) {
            if ($("#ctr" + i).length > 0) {
                    ...
                    $("#ctr" + i).find("input[name=btp_checkbox" + i + "]").each(function () {
                        if ($(this).attr("checked")) {
                            ...
                            if (type == 3 || type == 4) {
                                ...
                                if (count == "" || !(/^(\+|-)?\d+$/.test(count)) || count < 0) { p = 1; }
                            }
                        }
                    });
                    if (p == 1) { err = "请输入正确的值"; }
                ...
                if (cons == "functionUseTimes") {
                    ...
                    if (t == 0 || p == 1) { err = "请输入正确的值"; }
                    if (c == 0) { err = '请选择功能'; }
                    var bt = DateDiff($("#ctr" + i).find(".startDate").val(), $("#ctr" + i).find(".endDate").val());
                    if (bt > lt) { err = "功能使用时间范围超出限制时间范围"; }
                }
                //				if(cons == "isActive"){
                //					y++;
                //				}
                if (cons == "loginCount") {
                    ...
                    if (count == "" || isNaN(count) || count < 0) { p = 1; }
                    if (p == 1) { err = "请输入正确的值"; }
                    if ($("#ctr" + i).find(".startDate").val() == "" || $("#ctr" + i).find(".endDate").val() == "") {
                        err = "账号登录时间范围不能为空";
                    }
                    var bt = DateDiff($("#ctr" + i).find(".startDate").val(), $("#ctr" + i).find(".endDate").val());
                    if (bt > lt) { err = "账号登录时间范围超出限制时间范围"; }
                }
                if (cons == "onlineTime") {
                    var p = 0;
                    var hour = $.trim($("#ctr" + i).find(".onlineHour").val());
                    if (hour == "" || isNaN(hour) || hour < 0) { p = 1; }
                    if (p == 1) { err = "请输入正确的值"; }
                    if ($("#ctr" + i).find(".startDate").val() == "" || $("#ctr" + i).find(".endDate").val() == "") {
                        err = "账号在线时间范围不能为空";
                    }
                    var bt = DateDiff($("#ctr" + i).find(".startDate").val(), $("#ctr" + i).find(".endDate").val());
                    if (bt > lt) { err = "账号在线时间范围超出限制时间范围"; }
                }
            }
        }
        if (taskName == "") {
            ...
            mycomm_queryJsonData({
                url: basePath + "essencesale/addMiningTask.htm",
                data: { "miningTask": { "name": taskName } },
                success: function (result) {
                    if (result == 0) {
                        alert("当前正在运行的任务数量已达到程序的限制的数量，请等待其他任务结束后在添加");
                    } else {
                        mid = result;
                        ...
                        for (var i = 0; i < tr_count; i++) {
                            if ($("#ctr" + i).length > 0) {
                                ...
                                if (cons == "useTime") {
                                    ...
                                    var datas = "mid:" + mid + ",ct:1,dc1:{st=" + startDate + "_et=" + endDate + "}";
                                ...
                                if (cons == "userRegisterTime") {
                                    ...
                                    if (type == 4) {
                                        ...
                                        var datas = "mid:" + mid + ",ct:2,dc2:{type=" + type + "_days=0_st=" + startDate + "_et=" + endDate + "}";
                                        condtitions.push(datas);
                                        //    					alert(data[0].dc2);
                                    } else {
                                        var days = $.trim($("#ctr" + i).find(".registerday").val());
                                        var datas = "mid:" + mid + ",ct:2,dc2:{type=" + type + "_days=" + days + "_st=null_et=null}";
                                        condtitions.push(datas);
                                        //    					alert(data[0].dc2);	
                                    }
                                }
                                ...
                                if (cons == "useArea") {
                                    ...
                                    var datas = "mid:" + mid + ",ct:3,dc3:[" + text + "],st:" + startDate + ",et:" + endDate;
                                    condtitions.push(datas);
                                }
                                ...
                                if (cons == "product") {
                                    ...
                                    var datas = "mid:" + mid + ",ct:4,dc4:[" + text + "],st:" + startDate + ",et:" + endDate;
                                    condtitions.push(datas);
                                    //    				alert(data[0].dc4);
                                }
                                ...
                                if (cons == "buyType") {
                                    ...
                                    $("#ctr" + i).find("input[name=btp_checkbox" + i + "]").each(function () {
                                        if ($(this).attr("checked")) {
                                            if ($(this).val() == 1) { if (text == "") { text += "pt=2_pid=3"; } else { text += "&pt=2_pid=3"; } }
                                            if ($(this).val() == 2) { if (text == "") { text += "pt=2_pid=2"; } else { text += "&pt=2_pid=2"; } }
                                            if ($(this).val() == 3) { if (text == "") { text += "pt=2_pid=5"; } else { text += "&pt=2_pid=5"; } }
                                            if ($(this).val() == 4) { if (text == "") { text += "pt=12_pid=3"; } else { text += "&pt=12_pid=3"; } }
                                            if ($(this).val() == 5) { if (text == "") { text += "pt=12_pid=2"; } else { text += "&pt=12_pid=2"; } }
                                            if ($(this).val() == 6) { if (text == "") { text += "pt=12_pid=5"; } else { text += "&pt=12_pid=5"; } }
                                            if (type == 3 || type == 4) {
                                                var count = $.trim($(this).next('.nbuy').val());
                                                if ($(this).val() == 0) { text += "pt=2_pid=3_day=" + count + "&pt=2_pid=2_day=" + count + "&pt=2_pid=5_day=" + count + "&pt=12_pid=3_day=" + count + "&pt=12_pid=2_day=" + count + "&pt=12_pid=5_day=" + count; } else { text += "_day=" + count; }
                                            }
                                        }
                                    });
                                    var datas = "mid:" + mid + ",ct:5,dc5:{bt~" + type + "#param~[" + text + "]}";
                                    condtitions.push(datas);
                                ...
                                if (cons == "functionUseTimes") {
                                    ...
                                    var datas = "mid:" + mid + ",ct:6,dc6:{ft~" + ft + "#st~" + startDate + "#et~" + endDate + "#param~[" + text + "]}";
                                    condtitions.push(datas);
                                ...
                                if (cons == "isActive") {
                                    ...
                                    var datas = "mid:" + mid + ",ct:7,dc7:{ia=" + ia + "_wlc=" + wlc + "}";
                                    condtitions.push(datas);
                                    //    				alert(data[0].dc7);
                                ...
                                if (cons == "loginCount") {
                                    ...
                                    var count = $.trim($("#ctr" + i).find(".lgCount").val());
                                    var datas = "mid:" + mid + ",ct:8,dc8:{type=" + type + "_count=" + count + "_st=" + startDate + "_et=" + endDate + "}";
                                    condtitions.push(datas);
                                }
                                ...
                                if (cons == "onlineTime") {
                                    ...
                                    var hour = $.trim($("#ctr" + i).find(".onlineHour").val());
                                    var datas = "mid:" + mid + ",ct:9,dc9:{type=" + type + "_hour=" + hour + "_st=" + startDate + "_et=" + endDate + "}";
                                    condtitions.push(datas);
                                }

                            }
                        }
                        var url = basePath + "essencesale/addCondition.htm";
                        mycomm_queryJsonData({
                            url: url,
                        ...
                        //				    	var yyy="";
                        //				    	for(var i=0;i<condtitions.length;i++){
                        //				    		var ttt = condtitions[i];
                        //				    			yyy+= ttt +"<br/>";
                        //				    	}
                        //				    	$("#test").html(yyy);
    ...
    $("#reset").click(function () {
        location.href = "essencesale/requestStartMiningTaskPage.htm";
    });
});
...
var cdnChange = function cdnChange(selthis, k) {
    ...
    if (sc == "functionUseTimes") {
        ...
        mycomm_queryJsonData({
            url: basePath + "/essencesale/queryFunctionUseCondition.htm",
            data: {},
            success: function (result) {
                //    				alert(result.length);
