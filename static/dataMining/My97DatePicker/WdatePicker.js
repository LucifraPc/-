...
(function () {
  ...
  function b() {
    ...
    var w = {
      ...
      show: function () {
        var K = E[z].getElementsByTagName("div"),
          J = 100000;
  ...
  function m(w, I, J) {
    var d = n[z][H]("HEAD").item(0),
      e = n[z].createElement("link");
    if (d) {
      e.href = w;
      e.rel = "stylesheet";
      e.type = "text/css";
  ...
  function a(e, d) {
    ...
    function w(V, P) {
      var O = E[z].domain,
        S = false,
        M = '<iframe hideFocus=true width=10 height=8 frameborder=0 border=0 scrolling=no src="about:blank"></iframe>';
      V.innerHTML = M;
      var L = l.$langList,
        U = l.$skinList,
        T;
